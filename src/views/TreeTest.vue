<template>
    <el-container style="border: 1px solid #eee">
        <el-row style="width: 100%">
            <el-col :xs="10" :sm="10" :md="8" :lg="6" :xl="4" class="aside">
                <div class="asideButton">
                    <el-row>
                        <el-col>
                            <el-button type="primary" style="width: 220px" size="medium" plain round @click="handleNew">
                                发布新地址</el-button>
                        </el-col>
                    </el-row>
                    <el-row>
                        <el-col>
                            <el-input placeholder="搜索分类" prefix-icon="el-icon-search" v-model="filterText"
                                size="medium">
                            </el-input>
                        </el-col>
                    </el-row>
                ...
                <el-aside style="padding-top:10px">
                    <el-tree :data="setTree" :props="defaultProps" node-key="id" ref="SlotMenuList"
                        ...
                        <span class="slot-t-node" slot-scope="{ node, data }">
                            ...
                            <!-- 编辑输入框 -->
                            <span v-show="node.isEdit">
                                <el-input class="slot-t-input" size="mini" autofocus v-model="data.name"
                                    :ref="'slotTreeInput'+data.id" @blur.stop="NodeBlur(node, data)"
                    ...
                    <div v-show="menuVisible">
                        <el-menu id="rightClickMenu" class="el-menu-vertical" @select="handleRightSelect"
                            active-text-color="#ff0000" text-color="#ff0000" background-color="#000000">
        ...
        <el-dialog title="标签属性修改" :visible.sync="dialogFormVisible" width='30%'>
            <el-form :model="editObj" label-width="80px">
                <el-form-item label="标签名称">
                    <el-input type="textarea" :rows="2" autocomplete="off" placeholder="请输入内容" v-model="editObj.name">
                    </el-input>
                </el-form-item>
            </el-form>
        ...
        <el-dialog title="标签分类修改" :visible.sync="dialogClassifyVisible" width='30%'>
            <el-tree :data="setTree" :props="defaultProps" node-key="id" ref="SlotMenuList"
                @node-contextmenu='rihgtClick2' accordion>
                <span class="slot-t-node" slot-scope="{ node, data }">
                    <span v-show="!node.isEdit">
                        <span v-show="data.children && data.children.length >= 1">
            ...
            <div v-show="menuVisible2">
                <el-menu id="rightClickMenu2" class="el-menu-vertical" @select="handleRightSelect1"
        ...
        <el-dialog title="创建标签" :visible.sync="dialogNewFormVisible" width='30%'>
            <el-form label-width="80px">
                ...
                <el-form-item label="标签描述">
                    <el-input type="textarea" :rows="3" autocomplete="off" placeholder="请输入内容">
                    </el-input>
                </el-form-item>
            </el-form>
            <div slot="footer" class="dialog-footer">
