        ...
        methods: {
            ...
            fileChange(e) {
                try {
                    ...
                    axios.post('http://localhost:8083/findshpfile', this.urlfile).then(function (response) {
            ...
            fileurl() {
                axios.post('http://localhost:8083/findshpfile', this.input).then(function (response) {
                    console.log(response)
                })
            },
            // 导出
            uploadCode(event) {
                ...
                console.log(path)
                axios.post('http://localhost:8083/findshpfile', path).then(function (response) {
                    console.log(response)
                })
            }
